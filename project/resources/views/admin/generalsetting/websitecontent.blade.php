                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="input-field"
                                               ...
                                               name="copyright" value="{{ $gs->copyright }}" required="">
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="action-list">
                                            <select
                                                ...
                                                <option data-val="1"
                                                        value="{{route('admin-gs-status',['is_debug',1])}}" {{ $gs->is_debug == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>
                                                <option data-val="0"
                                                        value="{{route('admin-gs-status',['is_debug',0])}}" {{ $gs->is_debug == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="action-list">
                                            <select
                                                ...
                                                <option data-val="1"
                                                        value="{{route('admin-gs-status',['is_cookie',1])}}" {{ $gs->is_cookie == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>
                                                <option data-val="0"
                                                        value="{{route('admin-gs-status',['is_cookie',0])}}" {{ $gs->is_cookie == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="action-list">
                                            <select
                                                ...
                                                <option data-val="1"
                                                        value="{{route('admin-gs-status',['is_secure',1])}}" {{ $gs->is_secure == 1 ? 'selected' : '' }}>{{ __('Yes') }}</option>
                                                <option data-val="0"
                                                        value="{{route('admin-gs-status',['is_secure',0])}}" {{ $gs->is_secure == 0 ? 'selected' : '' }}>{{ __('No') }}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="action-list">
                                            <select
                                                ...
                                                <option data-val="1"
                                                        value="{{route('admin-gs-status',['is_capcha',1])}}" {{ $gs->is_capcha == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>
                                                <option data-val="0"
                                                        value="{{route('admin-gs-status',['is_capcha',0])}}" {{ $gs->is_capcha == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="action-list">
                                            <select
                                                ...
                                                <option data-val="1"
                                                        value="{{route('admin-gs-status',['is_verification_email',1])}}" {{ $gs->is_verification_email == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>
                                                <option data-val="0"
                                                        value="{{route('admin-gs-status',['is_verification_email',0])}}" {{ $gs->is_verification_email == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="action-list">
                                            <select
                                                ...
                                                <option data-val="1"
                                                        value="{{route('admin-gs-status',['is_talkto',1])}}" {{ $gs->is_talkto == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>
                                                <option data-val="0"
                                                        value="{{route('admin-gs-status',['is_talkto',0])}}" {{ $gs->is_talkto == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div>
                                            <textarea class="input-field"
                                                      readonly="">{{ url('/vendor/subscription/check') }}</textarea>
                                        </div>
                                    </div>
                                </div>
