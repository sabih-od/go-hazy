            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer
                        Notice, and all Agreements: "Client," "You," and "Your" refers to you, the person who logs on
                        this website and is compliant with the Company’s terms and conditions. "The Company,"
                        ...
                        appropriate manner for the express purpose of meeting the Client’s needs in respect of the
                        ...
                        to the same.</p>
                    <h6>Cookies</h6>
                    <p>We employ the use of cookies. By accessing Antony Garcia, you agreed to use cookies in agreement
                        with Antony Garcia’s Privacy Policy.</p>
                    <p>Most interactive websites use cookies to let us retrieve the user’s details for each visit.
                        ...
                        cookies.</p>
                    <h6>License</h6>
                    <p>Unless otherwise stated, Antony Garcia and/or its licensors own the intellectual property rights
                        for all material on Antony Garcia. All intellectual property rights are reserved. You may access
                        this from Antony Garcia for your own personal use, subject to restrictions set in these terms
                        and conditions.</p>
                    <p>You must not:</p>
                    <ul>
                        <li>Republish material from Antony Garcia</li>
                        <li>Sell, rent, or sub-license material from Antony Garcia</li>
                        <li>Reproduce, duplicate or copy material from Antony Garcia</li>
                        <li>Redistribute content from Antony Garcia</li>
                    </ul>
                    ...
                    <p>Parts of this website offer an opportunity for users to post and exchange opinions and
                        information in certain areas of the website. Antony Garcia does not filter, edit, publish or
                        review Comments prior to their presence on the website. Comments do not reflect the views and
                        opinions of Antony Garcia, its agents, and/or affiliates. Comments reflect the views and
                        opinions of the person who posts their views and opinions. To the extent permitted by applicable
                        laws, Antony Garcia shall not be liable for the Comments or for any liability, damages, or
                    ...
                    <p>Antony Garcia Preserves the right to monitor all Comments and to remove any Comments which can be
                        considered inappropriate, offensive, or cause a breach of these Terms and Conditions.</p>
                    <h6>You warrant and represent that:</h6>
                    ...
                    <p>You hereby grant Antony Garcia a non-exclusive license to use, reproduce, edit and authorize
                    ...
                    <p>We will approve link requests from these organizations if we decide that: (a) the link would not
                        ...
                        hyperlink compensates the absence of Antony Garcia, and (d) the link is in the context of
                    ...
                    <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to
                        our website, you must inform us by sending an e-mail to Antony Garcia. Please include your name,
                        your organization name, and contact information as well as the URL of your site, a list of any
                    ...
                    <h6>Approved organizations may hyperlink to our Website as follows:
                    </h6>
                    <ul>
                    ...
                    <p>No use of the Antony Garcia logo or other artwork will be allowed for linking absent a trademark
                        license agreement.
                    </p>
                    <h6>iFrames</h6>
