                    ...
                    <div class="whitebg">
                        ...
                        <form action="" class="formStyle form-row">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="newpass" class="form-control" placeholder="At least 6 characters">
                            </div>
                            <div class="input-group">
                                <label>Confirm Password<em>*</em></label>
                                <input type="text" name="renewpass" class="form-control" placeholder="At least 6 characters">
                            </div>
