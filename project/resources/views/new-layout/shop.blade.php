...
@section('content')
    ...
    <section class="inner-banner">
        @if(isset($data['cat']) && $data['cat']->image)
            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="shop-filter">
                        ...
                        <div class="rabge-set">
                            <label for="amount">Price: $<span id="min-amount">0</span> — $<span
                                    id="max-amount">200</span></label>
                            <p>
                    ...
                    <div id="accordion" class="faq-content">
                        <div class="card">
                            ...
                            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                ...
                                <div class="card-body">
                                    <ul class="discount">
                                        <li><a href="#" class="discountedFilter" data-filter="discounted">All
                                                Discount</a></li>
                        ...
                        <div class="card">
                            <div class="card-header" id="headingthre">
                                <button class="btn" data-toggle="collapse" data-target="#collapsethre"
                                        aria-expanded="true" aria-controls="collapsethre">
                                    Avg. Customer Review <i class="fas fa-caret-down"></i>
                                </button>
                            </div>
                            <div id="collapsethre" class="collapse show" aria-labelledby="headingthre"
                                 data-parent="#accordion">
                                <div class="card-body">
                                    <ul class="discount">
                                        <li><a href="#" class="highestToLowest" data-filter="highest">Highest to
                                                Lowest</a></li>
                                        <li><a href="#" class="lowestToHighest" data-filter="lowest">Lowest to
                                                Highest</a></li>
                                        <li><a href="#" class="bestSeller" data-filter="bestSeller">Best Sellers</a>
                                        </li>
                                        <li><a href="#" class="newestArrivalFilter" data-filter="newest">Newest
                                                Arrival</a></li>
                                    </ul>
                                </div>
                            </div>
