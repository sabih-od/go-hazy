                        ...
                        <li>
                            <div class="dropdown">
                                <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <img src="{{asset('assets/new-layout/images/flag.webp')}}" class="img-fluid" alt="img">
                                </button>
    ...
    <div class="an-navbar">
        <div class="container">
            <div class="row align-items-center">
                    ...
                    <div class="search">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <button class="btn btn-outline-secondary dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">All Category</button>
                            ...
                            <form method="GET" action="{{route('front.category')}}">
                                @csrf
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="Search here" aria-label="Search here" name="title">
                ...
                <div class="col-md-4">
                    <a href="{{route('front.index')}}" class="top-logo"><img src="{{asset('assets/new-layout/images/logo.webp')}}" class="img-fluid" alt="img"></a>
                </div>
                <div class="col-md-4">
                    <div class="cart-box">
                        <ul class="cart-list">
        ...
        <div class="swiper instaSlider" data-aos="fade">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <figure class="insta-img"><img src="{{asset('assets/new-layout/images/insta-img1.webp')}}" alt="image" class="img-fluid">
                    </figure>
                </div>
                <div class="swiper-slide">
                    <figure class="insta-img"><img src="{{asset('assets/new-layout/images/insta-img2.webp')}}" alt="image" class="img-fluid">
                    </figure>
                </div>
                <div class="swiper-slide">
                    <figure class="insta-img"><img src="{{asset('assets/new-layout/images/insta-img3.webp')}}" alt="image" class="img-fluid">
                    </figure>
                </div>
                <div class="swiper-slide">
                    <figure class="insta-img"><img src="{{asset('assets/new-layout/images/insta-img4.webp')}}" alt="image" class="img-fluid">
                    </figure>
                </div>
                <div class="swiper-slide">
                    <figure class="insta-img"><img src="{{asset('assets/new-layout/images/insta-img5.webp')}}" alt="image" class="img-fluid">
                    </figure>
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-2">
                <figure class="newsletter-img h-100" data-aos="zoom-out">
                    <img src="{{asset('assets/new-layout/images/newsletter-img1.webp')}}" alt="image" class="img-fluid w-100 h-100">
                </figure>
            </div>
            <div class="col-md-7">
            ...
            <div class="col-md-2">
                <figure class="newsletter-img h-100" data-aos="zoom-out">
                    <img src="{{asset('assets/new-layout/images/newsletter-img2.webp')}}" alt="image" class="img-fluid w-100 h-100">
                </figure>
            </div>
        </div>
    </div>
                ...
                <div class="footerInfo">
                    ...
                    <form class="signUp-form">
                        ...
                        <div class="signUp-input">
                            <input type="email" placeholder="Email address">
                            <button type="submit" class="border-0 bg-transparent"><i class="fas fa-arrow-right"></i></button>
                        </div>
                    </form>
