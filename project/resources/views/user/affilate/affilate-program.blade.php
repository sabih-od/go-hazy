                        ...
                        <div class="col-lg-12">
                            <div class="widget border-0 p-40 widget_categories bg-light account-info">
                                ...
                                <h4 class="widget-title down-line mb-30">{{ __('Affiliate Program') }}
                                    <a class="themeBtn" href="{{route('user-affilate-history')}}"> <i
                                            class="fas fa-history"></i> {{ __('Affiliate History') }}</a>
                                </h4>
                                                ...
                                                <div class="row pb-5">
                                                    ...
                                                    <div class="col-12 pt-2">
                                                        <a href="{{ url('/').'/?reff='.$user->affilate_code}}"
                                                           target="_blank"><img class="bannerPreview"
                                                ...
                                                <div class="row">
                                                    <div class="col-12 pt-2 f-14">
                                                        <label>{{ __('Affiliate Banner HTML Code *') }} <a
                                                                ...
                                                                class="themeBtn copy border px-3"><i
                                                                    class="fas fa-copy"></i></a></label>
                                                        <br>
                                                        <small>{{ __('This is your affilate banner html code just copy the code and paste anywhere you want.') }}</small>
                                                    </div>
                                                    <div class="col-12 pt-2">
                                                        <textarea id="affilate_html"
                                                                  class="input-field affilate from-control border w-100 p-4 h--150"
                                                                  name="address" readonly=""><a href="{{ url('/').'/?reff='.$user->affilate_code}}" target="_blank"><img src="{{asset('assets/images/'.$gs->affilate_banner)}}"></a></textarea>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
