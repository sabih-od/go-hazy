                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    @if($order->method != "Cash On Delivery")
                                                        ...
                                                        <a id="tid" style="cursor: pointer;"
                                                           class="themeBtn">{{ __('Edit Transaction ID')}}</a>
...
{{--                                                    <td>--}}
{{--                                                        <a class="fa fa-eye" style="color: cadetblue; cursor: pointer;"--}}
{{--                                                           data-toggle="modal"--}}
{{--                                                           data-target="#orderDetailsModal"--}}
{{--                                                           data-quantity="{{ $product['qty'] ?? '' }}"--}}
{{--                                                           data-color="{{ $product['options'][0]['option_display_name'] ?? '' }}"--}}
{{--                                                           data-size="{{ $product['options'][1]['option_display_name'] ?? ''}}"--}}
{{--                                                           data-details="{{ $product['product']['details'] ?? '' }}"--}}
{{--                                                           data-name="{{ $product['product']['name'] ?? '' }}">--}}
{{--                                                        </a>--}}
{{--                                                    </td>--}}
                                                    @if($product['price']['sale_price'])
                                                        <td>{{ number_format($product['price']['sale_price'], 2) ?? '' }}</td>
                                                    @else
                                                        <td>{{ number_format($product['price']['original_price'], 2) ?? '' }}</td>
                                                    @endif
                                                    <td>
                                                        @if($product['price']['sale_price'])
                                                            {{ number_format($product['price']['sale_price'], 2) ?? '' }}
                                                        @else
                                                            {{ number_format($product['price']['original_price'], 2) ?? '' }}
                                                        @endif
                                                    </td>
                                                </tr>
                                            @endforeach
