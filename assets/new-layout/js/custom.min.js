		...
		if (upto === 100) {
			...
			tl.to(".preLoader .counter", {
				...
				.from('.top-logo > img', {
					...
					1)
				.from(
					".top-menu > li, .headline, .deliver > li", {
					x: 50,
					stagger: 0.1,
					autoAlpha: 0,
				},
				...
				.from(
					".an-navbar .search, .cart-list > li, .menuBar", {
					scale: 0,
					stagger: 0.1,
					autoAlpha: 0,
				},
...
function allSlider() {
	let heroSlider = new Swiper('.heroSlider', {
		...
		slidesPerView: 1,
		centeredSlides: true,
		spaceBetween: 0, // Ensure no extra space between slides
		breakpoints: {
			1024: {
				slidesPerView: 'auto',
				spaceBetween: 70
	...
	let exploreSlider = new Swiper('.exploreSlider', {
		loop: true,
		// autoplay: true,
		slidesPerView: 1,
	...
	let trendSlider = new Swiper('.trendSlider', {
		loop: true,
		speed: 5000,
		slidesPerView: 1,
		autoHeight: true,
	...
	let arrivalimgSlider1 = new Swiper('.arrivalimgSlider1', {
		loop: true,
		speed: 5000,
		slidesPerView: 1,
		autoHeight: true,
	...
	let arrivalimgSlider2 = new Swiper('.arrivalimgSlider2', {
		loop: true,
		speed: 5000,
		slidesPerView: 1,
		autoHeight: true,
	...
	let logoSlider_one = new Swiper('.logoSlider-one', {
		loop: true,
		slidesPerView: 1,
		spaceBetween: 20,
		autoplay: {
	...
	let logoSlider_two = new Swiper('.logoSlider-two', {
		loop: true,
		slidesPerView: 1,
		spaceBetween: 20,
		autoplay: {
	...
	let instaSlider = new Swiper('.instaSlider', {
		loop: true,
		autoplay: true,
		slidesPerView: 1,
		spaceBetween: 20,
...
function featureSection() {
	let featureSlider = new Swiper('.featureSlider', {
		loop: true,
		autoplay: {
			delay: 1500,
			disableOnInteraction: false
